...
class Clock extends React.Component {
  ...
  render() {
    return (
      <div className={[classes.box, this.props.boxClassName].join(" ")}>
        <canvas
          title="Clock"
          ...
          className={[classes.Clock, this.props.className].join(" ")}
          ref="clockCanvas"
          id="CCC"
        ...
        {this.state.isHovering && (
          <Tag className={classes.tag}>Alarm, Stopwatch, Timer</Tag>
        )}
      </div>
    );
  }
