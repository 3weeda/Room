...
class AutoScalingText extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={classes.AutoScalingText}
  ...
  render() {
    ...
    return (
      <PointTarget onPoint={onPress}>
        <button
          className={[classes.CalculatorKey, this.props.className].join(" ")}
          {...props}
        />
      </PointTarget>
    );
...
class Calculator extends React.Component {
  ...
  componentWillUnmount() {
    ReactDOM.findDOMNode(this).removeEventListener("keydown", this.handleKeyDown);
  }
  ...
  render() {
    ...
    return (
      <Auxiliary>
        <div
          className={this.props.visible ? classes.CalculatorApp : classes.hide}
        >
            ...
            <div className={classes.KeyPad}>
              <div className={classes.InputKeys}>
                ...
                <div className={classes.DigitKeys}>
                  <CalculatorKey
                    className={classes.KeyZero}
                    onPress={() => this.inputDigit(0)}
                  >
                    0
                  </CalculatorKey>
                  <CalculatorKey
                    className={classes.KeyDot}
